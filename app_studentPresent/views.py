...
def AddNewStudent(request, template_name='app_studentPresent/add_participation.html'):
...
def update_data(request,id,template_name='app_studentPresent/updateStudent.html'):
    if request.method=='POST':
